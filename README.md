...
2. Ограничить компонент Chats определенным минимальным размером (-)
3. Ошибка read-access-violation когда прыгаю по разным чатам (-)
https://embeddeduse.com/2018/04/02/qml-engine-deletes-c-objects-still-in-use/
2. Сделать красивый UI отображения чатов + чата как в Telegram (-)
3. Отрефакторить весь код (-)
